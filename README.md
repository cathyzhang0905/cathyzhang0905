...
**AI 原生产品经理 · 用真实问题驱动构建 · 通过发布来学习，通过构建来思考**

我是一名正在转向 AI 原生产品构建的产品经理。相比只讨论概念，我更喜欢从自己的真实问题出发，把问题做成工具，再用工具反过来训练自己的产品判断力。

我最近主要关注两条线：

- **智能体协作与监督**：让智能体在执行前暴露关键决策点，让人更容易理解、介入和信任它的工作过程。
- **个人信息操作系统**：重新设计我每天如何收集、阅读、筛选、转化和沉淀信息。
...
### 个人信息操作系统
- [`wechat-radar`](https://github.com/cathyzhang0905/wechat-radar) — AI 公众号智能日报，从几十个公众号里筛出每天值得读的几篇文章。
- [`wechat-article-reader`](https://github.com/cathyzhang0905/wechat-article-reader) — Claude Code 技能：无需接口令牌，让 Claude 阅读和搜索微信公众号文章。
...
我在寻找信息流之外的真实问题，尤其关注：AI 智能体产品、智能体评估流程、AI 原生产品经理工具，以及如何让非工程背景的人真正能够借助 AI 发布产品。

---

## Hi, I'm Cathy 👋

**AI-native PM · Builder by need · Ship to learn, build to think**
...
### Personal information OS
- [`wechat-radar`](https://github.com/cathyzhang0905/wechat-radar) — An AI-powered daily digest for WeChat official accounts.
- [`wechat-article-reader`](https://github.com/cathyzhang0905/wechat-article-reader) — A Claude Code skill for reading and searching WeChat official account articles without API tokens.
...
Senior PM @ DiDi · AI-native product builder · Based in China
